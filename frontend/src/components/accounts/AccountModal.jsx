...
export default function AccountModal({ open, onClose, onSave, initial }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-0 sm:p-4 pb-16 sm:pb-4">
      ...
      <div className="relative bg-white dark:bg-gray-900 w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[85svh] sm:max-h-[92vh] flex flex-col animate-slide-up">
